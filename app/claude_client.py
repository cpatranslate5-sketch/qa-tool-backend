...
[
  {{"row": <номер пары из списка выше>, "type": "{type_enum}", "severity": "low|medium|high", "message": "конкретное описание на русском, с указанием конкретного предложения/фрагмента, если в паре их несколько"}},
